/**
 * Created by patrick conroy on 8/26/14.
 */

(function () {
    //Barchart
    var coreStats = [
        {name: "Library of Congress", numDocs: 10},
        {name: "White House", numDocs: 1400 },
        {name: "CIA", numDocs: "521"},
        {name: "DEP", numDocs: "240"}
    ];
    ...
    d3.csv(options.fileName, function (data) {
        ...
        options.data = data.map(function (d) {
